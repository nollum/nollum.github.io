    ...
    <div class="text-xl" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", margin: "10vh 20vw"}}>
        ...
        <div class="text-lg" style={{ display: "flex", flexDirection: "column", justifyContent: "center", maxWidth: "50vw" }}> 
          <p style={{margin: "20px"}}>
            ...
            I am primarily interested in distributed computing, embedded systems, and cybersecurity. I also like to dabble in web development every now and again (except the frontend part, as I'm sure you can tell).
          </p>
